...
import xyz.denprog.codefestredopractice.admin.room_management.placeholder.PlaceholderContent.PlaceholderItem;
...
public class MyRoomsManagementRecyclerViewAdapter extends RecyclerView.Adapter<MyRoomsManagementRecyclerViewAdapter.ViewHolder> {
    ...
    public MyRoomsManagementRecyclerViewAdapter(List<PlaceholderItem> items) {
        mValues = items;
    }
